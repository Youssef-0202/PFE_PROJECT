...
public class RadiologieConverter {
    ...
    public Radiologie toItem(RadiologieDto dto) {
        ...
        Radiologie item = new Radiologie();
            ...
            if(dto.getConsultatuin() != null && dto.getConsultatuin().getId() != null){
                ...
                item.getConsultation().setId(dto.getConsultatuin().getId());
                item.getConsultation().setRef(dto.getConsultatuin().getRef());
            }
    ...
    public RadiologieDto toDto(Radiologie item) {
        if (item == null) {
            ...
            if(this.consultatuin && item.getConsultation()!=null) {
                dto.setConsultatuin(consultationConverter.toDto(item.getConsultation())) ;
    ...
    public void copy(RadiologieDto dto, Radiologie t) {
        ...
        consultationConverter.copy(dto.getConsultatuin(), t.getConsultation());
